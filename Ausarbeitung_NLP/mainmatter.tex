...
Die Architektur von \enquote{Lingotrain AI} folgt einem modernen \textbf{Client-Server-Modell}, sodass die Benutzeroberfläche von der Geschäftslogik getrennt wird. 
Während das Frontend in \textit{Vue.js} umgesetzt ist und die Benutzerinteraktionen verwaltet, übernimmt das in Python entwickelte Backend die Verarbeitung natürlicher Sprache (NLP)
sowie die Anbindung an externe Sprachmodelle.
